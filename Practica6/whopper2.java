...
areadetexo.setBounds(10,200,400,150);
areadetexo.setEditable(false);
add(areadetexo);

scroll = new JScrollPane(areadetexo);
scroll.setBounds(10,200,400,160);
add(scroll);
